...
export const teamMembers: TeamMember[] = [
  {
    ...
    bio: 'With over 12 years of experience in luxury event management, Sanjay has orchestrated more than 300 weddings and corporate events across India. His vision for SS Event has always been about creating timeless experiences that exceed expectations.',
  ...
  },
  {
    ...
    bio: 'Shreya\'s artistic eye and passion for floral design have become SS Event\'s signature. Having trained under celebrated decorators in Mumbai and Dubai, she brings a global aesthetic to every event while honoring Indian traditions.',
  ...
  },
  {
    ...
    bio: 'Priya manages SS Event\'s entertainment division with an insider knowledge of the industry. From booking celebrity performers to coordinating live bands, she ensures the entertainment at every event is utterly unforgettable.',
