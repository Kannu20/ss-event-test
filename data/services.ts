...
const WEDDING_CHILDREN: ServiceNode[] = [
  /* ── Haldi ─────────────────────────────── */
  {
    ...
    gallery: {
      ...
      highlight: 'Moments',
      media: [
        { type: 'image', src: '/images/haldi7.jpeg', alt: 'Haldi ceremony hosted by Shubham Khandelwal' },
        { type: 'image', src: '/images/haldi4.jpeg', alt: 'Turmeric ceremony with folk songs' },
        { type: 'video', src: '/videos/haldi1.mov', alt: 'Haldi celebration film', poster: '/images/haldi6.jpeg' },
        ...
        { type: 'image', src: '/images/haldi8.jpeg', alt: 'Joyful haldi morning moments' },
  ...
  /* ── Mehendi ───────────────────────────── */
  {
    ...
    gallery: {
      ...
      media: [
        ...
        { type: 'video', src: '/videos/mehandi1.mp4', alt: 'Mehendi celebration film', poster: '/images/mehandi7.jpeg' },
  ...
  /* ── Sangeet ───────────────────────────── */
  {
    ...
    gallery: {
      ...
      media: [
        ...
        { type: 'video', src: '/videos/sangeet.mp4', alt: 'Sangeet night highlights', poster: '/images/sangeet11.jpeg' },
        { type: 'image', src: '/images/sangeet10.jpeg', alt: 'Family dance at the sangeet' },
        { type: 'video', src: '/videos/sangeet1.mp4', alt: 'Sangeet night highlights', poster: '/images/sangeet12.jpeg' },
  ...
  /* ── Varmala ───────────────────────────── */
  {
    ...
    heroImage: '/images/varmala6.jpeg',
    intro: {
  ...
  /* ── Fashion Shows ─────────────────────── */
  {
    ...
    gallery: {
      ...
      media: [
        ...
        { type: 'image', src: '/images/cele1.jpeg', alt: 'Stage show hosting' },
        { type: 'image', src: '/images/cele2.jpeg', alt: 'Stage show hosting' },
  ...
  /* ── Live Shows ────────────────────────── */
  {
    ...
    gallery: {
      ...
      media: [
        ...
        { type: 'image', src: '/images/cele4.jpeg', alt: 'Stage show performance' },
        { type: 'image', src: '/images/show.jpeg', alt: 'Cultural show production' },
        { type: 'image', src: '/images/show5.png', alt: 'Cultural show production' },
        { type: 'image', src: '/images/show4.png', alt: 'Stage show performance' },
        { type: 'video', src: '/videos/live-show1.mp4', alt: 'Live show highlight film', poster: '/images/celeb4.jpeg' },
  ...
  /* ── Social Events ─────────────────────── */
  {
    ...
    gallery: {
      ...
      media: [
        ...
        { type: 'image', src: '/images/birthday1.jpeg', alt: 'Community gathering hosting' },
        { type: 'video', src: '/videos/social-event.mp4', alt: 'Social event highlight film', poster: '/images/social.jpeg' },
        { type: 'video', src: '/videos/social.mp4', alt: 'Social event highlight film', poster: '/images/social1.jpeg' },
        { type: 'image', src: '/images/about2.jpeg', alt: 'Shubham Khandelwal hosting a gathering' },
        { type: 'image', src: '/images/corparate.jpeg', alt: 'Shubham Khandelwal hosting a gathering' },
      ],
    },
    faqs: [
  ...
  /* ═══ Parties ═══ */
  {
    ...
    gallery: {
      ...
      media: [
        ...
        { type: 'image', src: '/images/mehan.jpeg', alt: 'Shubham Khandelwal hosting a party' },
      ],
    },
    faqs: [
  ...
  /* ═══ Events ═══ */
  {
    ...
    gallery: {
      ...
      media: [
        ...
        { type: 'image', src: '/images/mehan.jpeg', alt: 'Award night hosting' },
