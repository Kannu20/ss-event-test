...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Artist Shubham Khandelwal  — Premium Event Management Company',
    template: '%s | Artist Shubham Khandelwal ',
  },
  description:
    'Artist Shubham Khandelwal  is a full-service premium event management company specializing in weddings, corporate events, social celebrations, entertainment services, and production setup.',
  keywords: [
    'event management',
    'wedding planner',
    'corporate events',
  ...
  authors: [{ name: 'Artist Shubham Khandelwal ' }],
  creator: 'Artist Shubham Khandelwal ',
  openGraph: {
    type: 'website',
    locale: 'en_IN',
    url: '/',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Artist Shubham Khandelwal  — Premium Event Management',
      },
    ],
  },
  twitter: {
